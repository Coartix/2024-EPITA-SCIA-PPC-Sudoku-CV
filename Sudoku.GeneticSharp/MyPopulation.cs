...
namespace Sudoku.GeneticSharp
{
    public class MyPopulation : IPopulation
  {
    ...
    public virtual void EndCurrentGeneration()
    {
      ...
      // Print currentGeneration number followed by bestChromosome fitness
      Console.WriteLine($"Generation Number: {this.CurrentGeneration.Number} Fitness: {this.BestChromosome.Fitness}");
    }
